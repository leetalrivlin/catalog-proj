...
const gProducts = [
  ...
  },
  {
    ...
    "ProductImage": "https://www.toysrus.com/diy-activities/water-blaster-races-activity.html",
    "ThumbnailProductImage": null,
    "Price": 9.99,
    "PriceLabel": "$9.99",
    "ProductTags": [
...
function remove(productId) {
  return storageService.remove(PRODUCTS_KEY, productId);
}

function save(product) {
  if (product.ProductId) {
    return storageService.put(PRODUCTS_KEY, product);
  } else {
    return storageService.post(PRODUCTS_KEY, product);
  }
}
